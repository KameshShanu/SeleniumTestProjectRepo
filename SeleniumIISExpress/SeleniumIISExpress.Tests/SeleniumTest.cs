...
namespace SeleniumIISExpress.Tests
{
    [TestClass]
    public class SeleniumTest
    {        
        const int iisPort = 2020;
        private string _seleniumIISExpress;
        private Process _iisProcess;

        protected SeleniumTest(string seleniumIISExpress)
        {
            _seleniumIISExpress = seleniumIISExpress;
        }
        ...
        {
            var applicationPath = GetApplicationPath(_seleniumIISExpress);
        ...
        protected virtual string GetApplicationPath(string seleniumIISExpress)
        {
            var solutionFolder = Path.GetDirectoryName(Path.GetDirectoryName(Path.GetDirectoryName(AppDomain.CurrentDomain.BaseDirectory)));
            return Path.Combine(solutionFolder, seleniumIISExpress);
        }
